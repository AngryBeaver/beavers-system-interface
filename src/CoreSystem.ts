...
export class CoreSystem implements BeaverSystem {
  ...
  checkValidity() {
    if (this._modules.length > 0 && this._implementation === undefined) {
      ...
      ui.notifications.error(
        "Beavers System Interface | missing module BSA - " +
        (game as foundry.Game).system.id +
          " <a href='https://github.com/AngryBeaver/beavers-system-interface/wiki/BSA-x-links'>module links</a>",
        { permanent: true },
      );
  ...
  get configSkills(): SkillConfig[] {
    ...
    if (this._implementation?.configSkills !== undefined) {
      ...
      throw Error(
        (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + " configSkills",
      );
    }
  }
  ...
  get configAbilities(): AbilityConfig[] {
    ...
    if (this._implementation?.configAbilities !== undefined) {
      ...
      throw Error(
        (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + " configAbilities",
      );
    }
  }
  ...
  get configCurrencies(): CurrencyConfig[] {
    ...
    if (this._implementation?.configCurrencies !== undefined) {
      ...
      this._checkImplementation();
      throw Error(
        (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + " configCurrencies",
      );
    }
  }
  ...
  get configCanRollAbility(): boolean {
    ...
    if (this._implementation?.configCanRollAbility !== undefined) {
      ...
      throw Error(
        (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + " configCanRollAbility",
      );
    }
  }
  ...
  get configLootItemType(): string {
    ...
    if (this._implementation?.configLootItemType !== undefined) {
      ...
      throw Error(
        (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + " configLootItemType",
      );
    }
  }
  ...
  actorRollAbility(actor, abilityId: string): Promise<Roll | null> {
    ...
    if (this._implementation?.actorRollAbility !== undefined) {
      ...
      throw Error(
        (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + "actorRollAbility",
      );
    }
  }
  ...
  actorRollSkill(actor, skillId: string): Promise<Roll | null> {
    ...
    if (this._implementation?.actorRollSkill !== undefined) {
      ...
      throw Error(
        (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + "actorRollSkill",
      );
    }
  }
  ...
  actorRollTool(actor, item): Promise<Roll | null> {
    ...
    if (this._implementation?.actorRollTool !== undefined) {
      ...
      throw Error(
        (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + "actorRollTool",
      );
    }
  }
  ...
  actorCurrenciesGet(actor): Currencies {
    if (this._implementation?.actorCurrenciesGet !== undefined) {
      ...
      if (this._configCurrencies === undefined) {
        this._checkImplementation();
        throw Error(
          (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + "actorGetCurrencies",
        );
      }
  ...
  async actorCurrenciesAdd(actor, currencies: Currencies, doExchange: boolean = true): Promise<void> {
    ...
    if (this._implementation?.actorCurrenciesStore !== undefined) {
      ...
      if (this._configCurrencies === undefined) {
        throw Error(
          (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + "actorCurrenciesAdd",
        );
      }
  ...
  get actorSheetTabSelector(): string {
    this._checkImplementation();
    if (this._implementation?.actorSheetTabSelector !== undefined) {
      return this._implementation.actorSheetTabSelector;
    } else {
      return '[data-group="primary"] [data-tab]';
    }
  }
  ...
  actorSheetAddTab(
    ...
    html,
    actor: Actor,
    tabData: { id: string; label: string; html: string },
    tabBody: string,
  ): void {
    this._checkImplementation();
    if (this._implementation?.actorSheetAddTab !== undefined) {
      ...
      throw Error(
        (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + "actorSheetAddTab",
      );
    }
  }
        ...
        if (remainingQuantity < 0) {
          throw new Error(
            "Beavers System Interface | " +
              (game as foundry.Game)["i18n"].localize("beaversSystemInterface.RemainingQuantityLessThenZero") +
              component.name,
          );
        }
        ...
        if (remainingEquivalentQuantity <= 0) {
          ...
          for (const c of rest) {
            ...
            if (remainingEquivalentQuantity > 0) {
              ...
              this.objectAttributeSet(
                update,
                beaversSystemInterface.itemQuantityAttribute,
                remainingEquivalentQuantity,
              );
          ...
          //equivalentComponents are enough update those
  ...
  async uuidToDocument(uuid: string): Promise<foundry.abstract.Document<any, any>> {
    ...
    if (result === null) {
      throw new Error(
        "Beavers System Interface | " +
          (game as foundry.Game)["i18n"].localize("beaversSystemInterface.DocumentNotFound") +
          uuid,
      );
    }
    return result;
  ...
  get itemQuantityAttribute(): string {
    ...
    if (this._implementation?.itemQuantityAttribute !== undefined) {
      ...
      throw Error(
        (game as foundry.Game)["i18n"].localize("beaversSystemInterface.MethodNotSupported") + "itemQuantityAttribute",
      );
    }
  }
